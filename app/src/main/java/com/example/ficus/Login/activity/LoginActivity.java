package com.example.ficus.Login.activity;
...
public class LoginActivity extends AppCompatActivity
        ...
        */
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                // 2、构建请求体requestBody
                final String userAccount=telphone;  // 为了让键和值名字相同，我把account改成了telphone，没其他意思
                ...
                okHttpClient.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        if (responseStr.contains("200")) {
                            ...
                            if (getStatus(responseBodyJSONObject).equals("200")){
                            /*
                             更新token，下次自动登录
                             真实的token值应该是一个加密字符串
    ...
    */
    ...
    /*解析用户的id:
     */
    private String getuserId(JsonObject responseBodyJSONObject)
    {
        String id=responseBodyJSONObject.get("userId").getAsString();
        return id;
    }
    /*
